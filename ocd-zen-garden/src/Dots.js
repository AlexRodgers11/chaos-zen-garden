        ...
        <div>
            ...
            <div style={{width: '45%', margin: '0 auto'}}>
                {displayDots().map(dotLine => {
                    return <p style={{marginBlockEnd: 0, marginBlockStart: 0, marginBottom: '0 2.5px', padding: 0}}>
                        {dotLine.map(dot => {
                            return <span style={{display: 'inline-block', border: '1px solid black', borderRadius: '50%', width: '20px', height: '20px', margin: '30px', marginBottom: '30px'}}></span>
                        })}
                    </p>
                })}
