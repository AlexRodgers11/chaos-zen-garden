            ...
            <div>
                {displayHorns().map((hornLine, lineIdx) => {
                    return (
                        ...
                        <div className="outer" style={{padding: '0', height: `${(Math.floor(props.width / 3 * .65 / numRows))}px`}}>
                        {/* // <div className="outer" style={{padding: '0', height: `${(props.width / 3 * .65 / numRows) + (props.width / 3 * .65 / numRows) / 30}px`, marginBottom: `${props.width / 3 * .65 / (numRows ** 2)}px`}}> */}
                            ...
                            <div style={{margin: '0', height: `${(Math.floor(props.width / 3 * .65 / numRows) / 2) - 1}px`}}>
                                {hornLine.map(horn => {
                                    return (
                            ...
                            <div style={{margin: `0 ${.2 * props.width * .33 - 0 * (props.width * .33 * .6 / (numRows * 4))}px`, backgroundColor: 'black', height: 0, border: `1px solid ${getColor('border', colorPalette)}`, width: `${props.width * .33 * .6 - ((props.width * .33 * .6 / (numRows * 4)))}px`}}></div>
