            ...
            <div>
                {displayHorns().map((hornLine, lineIdx) => {
                    return (
                        ...
                        <div className="outer" style={{padding: '0', height: `${(props.width / 3 * .65 / numRows)}px`, marginBottom: `${props.width / 3 * .65 / (numRows ** 2)}px`}}>
                        {/* // <div className="outer" style={{padding: '0', height: `${(props.width / 3 * .65 / numRows) + (props.width / 3 * .65 / numRows) / 30}px`, marginBottom: `${props.width / 3 * .65 / (numRows ** 2)}px`}}> */}
                            ...
                            <div style={{margin: '0', height: `${(props.width * .65 / 2 / numRows) -1 }px`}}>
                                {hornLine.map(horn => {
                                    return (
